<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Paket Harga Baru') }}
        </h2>
    </x-slot>

    <div class="py-12 bg-gray-50 min-h-[calc(100vh-64px)]">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('admin.pricing-plans.store') }}" method="POST" class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 p-8 space-y-6">
                @csrf

                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="name" class="block text-sm font-semibold text-gray-700 mb-2">Nama Paket</label>
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Contoh: Babad Alas" required>
                ...
                <div>
                    ...
                    <input type="text" name="description" id="description" value="{{ old('description') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Contoh: Cocok buat yang baru mau merintis usaha." required>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="original_price" id="original_price" value="{{ old('original_price') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Contoh: Rp 850.000">
                    ...
                    <div>
                        ...
                        <input type="text" name="promo_price" id="promo_price" value="{{ old('promo_price') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Contoh: 499k atau 1.2jt" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_popular" id="is_popular" value="1" {{ old('is_popular') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 h-5 w-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="popular_badge" id="popular_badge" value="{{ old('popular_badge', 'Paling Laris') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="Contoh: Paling Laris">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="bg_color" id="bg_color" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            <option value="bg-white" {{ old('bg_color') == 'bg-white' ? 'selected' : '' }}>Putih (bg-white)</option>
                            <option value="bg-jogjayellow" {{ old('bg_color') == 'bg-jogjayellow' ? 'selected' : '' }}>Kuning Bata (bg-jogjayellow)</option>
                            <option value="bg-jogjadark" {{ old('bg_color') == 'bg-jogjadark' ? 'selected' : '' }}>Gelap (bg-jogjadark)</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="text_color" id="text_color" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            <option value="text-jogjadark" {{ old('text_color') == 'text-jogjadark' ? 'selected' : '' }}>Gelap (text-jogjadark)</option>
                            <option value="text-white" {{ old('text_color') == 'text-white' ? 'selected' : '' }}>Putih (text-white)</option>
                        </select>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="cta_text" id="cta_text" value="{{ old('cta_text', 'Pilih Paket') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="cta_link" id="cta_link" value="{{ old('cta_link', '#kontak') }}" class="w-full rounded-xl border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
